...
export default function CaseStudy() {
  ...
  return (
    <div className="[&_p,li]:tracking-[-0.5px] [&_section]:space-y-4 no-scrollbar -mx-4 overflow-y-auto px-4 lg:px-6 lg:border-x [&_img]:rounded-md [&_h2,h3]:mb-1 [&_h2]:text-3xl [&_h2,h3]:font-medium pt-25 [&_section]:mb-8 [&_section]:first:pt-0 [&_section]:pt-0! [&_img]:shadow-sm [&_figcaption]:mt-1 *:last:pb-60 dark:[&_p]:text-muted-foreground [&_img]:border">
      {study?.content}
